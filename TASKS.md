...
- [x] **MM-02** Bespoke **1200×630** `assets/og-image.png` (vinyl motif + title/tagline, generated by `scripts/make_icons.py:make_og_image`); wired as `og:image`/`twitter:image` with `twitter:card=summary_large_image`
...
- [x] **PP-01** Migration `004_song_ratings.sql` — one row per (user, track), upsert on re-rate
